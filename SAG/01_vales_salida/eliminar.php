...
if ((isset($_GET['id_vale_salida'])) && ($_GET['id_vale_salida'] != "")) {
  $deleteSQL = sprintf("DELETE FROM vale_salida WHERE id_vale_salida=%s",
                       GetSQLValueString($_GET['id_vale_salida'], "int"));
