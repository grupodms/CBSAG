...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE  vale_salida SET  id_vale_salida_tipo=%s, id_periodo=%s, id_dependencia=%s, id_empleado_tm=%s, id_empleado_tv=%s, fecha=%s, numero_vale=%s, fecha_vale_traspaso=%s, numero_factura=%s, observaciones=%s, id_subdependencia=%s where id_vale_salida=%s" ,
                
                GetSQLValueString($_POST['id_vale_salida_tipo'], "int"),
...
mysql_select_db($database_SAG, $SAG);
$query_vale_salida = sprintf("SELECT * FROM vale_salida WHERE id_vale_salida = %s", GetSQLValueString($colname_vale_salida, "int"));
...
mysql_select_db($database_SAG, $SAG);
$query_vale_salida_tipo = "SELECT * FROM vale_salida_tipo ORDER BY clave_vale_salida_tipo ASC";
$vale_salida_tipo = mysql_query($query_vale_salida_tipo, $SAG) or die(mysql_error());
$row_vale_salida_tipo = mysql_fetch_assoc($vale_salida_tipo);
$totalRows_vale_salida_tipo = mysql_num_rows($vale_salida_tipo);
?>
...
<title>Editar Vale de Salida</title>
</head>
<body>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <input type="hidden" name="id_vale_salida" value="<?php echo $row_vale_salida['id_vale_salida']; ?>" />
  <table align="center" width="100%">
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap="nowrap"><p align="right">Fecha:</p></td>
      <td colspan="2"><p align="left">
        <input name="fecha" type="text"
           class="alert-success" id="comodato_fecha5" value="<?php echo $row_vale_salida['fecha']; ?>"readonly="readonly" />
      </p></td>
      <td><p align="right">Numero Vale:</p></td>
      <td><p align="left">
        <input name="numero_vale" type="text"
           id="numero_vale" value="<?php echo $row_vale_salida['numero_vale']; ?>"  />
      </p></td>
      <td><p align="right">Fecha Vale :</p></td>
      <td><p align="left">
        <input name="fecha_vale_traspaso" type="text"
           class="alert-success" id="fecha_vale_traspaso" value="<?php echo $row_vale_salida['fecha_vale_traspaso']; ?>" readonly="readonly" />
      </p></td>
    </tr>
    <tr valign="baseline">
      ...
      <td width="121"><p align="left">
        <select name="id_vale_salida_tipo" id="id_vale_salida_tipo">
          <option value="0" <?php if (!(strcmp(0, $row_vale_salida['id_vale_salida_tipo']))) {echo "selected=\"selected\"";} ?>></option>
          <?php
do {  
?>
          <option value="<?php echo $row_vale_salida_tipo['id_vale_salida_tipo']?>"<?php if (!(strcmp($row_vale_salida_tipo['id_vale_salida_tipo'], $row_vale_salida['id_vale_salida_tipo']))) {echo "selected=\"selected\"";} ?>><?php echo $row_vale_salida_tipo['descripcion_vale_salida_tipo']?></option>
          <?php
} while ($row_vale_salida_tipo = mysql_fetch_assoc($vale_salida_tipo));
  $rows = mysql_num_rows($vale_salida_tipo);
  if($rows > 0) {
      mysql_data_seek($vale_salida_tipo, 0);
	  $row_vale_salida_tipo = mysql_fetch_assoc($vale_salida_tipo);
  }
?>
        </select>
      ...
      <td width="67"><p align="left">
        <input name="numero_factura" type="text"
            id="numero_factura" value="<?php echo $row_vale_salida['numero_factura']; ?>" />
      </p></td>
      <td width="11">&nbsp;</td>
    </tr>
    <tr valign="baseline">
      ...
      value="<?php echo $row_vale_salida['id_dependencia']; ?>" size="11" readonly="readonly" />
      </p></td>
      <td width="62">&nbsp;</td>
      <td><p align="right">SubDependencia:</p></td>
      <td colspan="2"><p align="left">
        <select name="id_subdependencia" id="id_subdependencia">
          <option value="0" <?php if (!(strcmp(0, $row_vale_salida['id_dependencia']))) {echo "selected=\"selected\"";} ?>></option>
        </select>
    ...
    <tr valign="baseline">
      ...
      " rows="5"><?php echo $row_vale_salida['observaciones']; ?></textarea>
      </p></td>
      <td>&nbsp;</td>
    </tr>
    <tr valign="baseline">
      ...
      <td colspan="6" ><p align="left">
        <select name="id_empleado_tm" id="id_empleado_tm">
          <option value="0" <?php if (!(strcmp(0, $row_vale_salida['id_empleado_tm']))) {echo "selected=\"selected\"";} ?>></option>
          <?php
do {  
?>
          <option value="<?php echo $row_TM['id_empleado']?>"<?php if (!(strcmp($row_TM['id_empleado'], $row_vale_salida['id_empleado_tm']))) {echo "selected=\"selected\"";} ?>><?php echo $row_TM['lista']?></option>
          <?php
    ...
    <tr valign="baseline">
      ...
      <td colspan="6"><p align="left">
        <select name="id_empleado_tv" id="id_empleado_tv">
          <option value="0" <?php if (!(strcmp(0, $row_vale_salida['id_empleado_tv']))) {echo "selected=\"selected\"";} ?>></option>
          <?php
do {  
?>
          <option value="<?php echo $row_TV['id_empleado']?>"<?php if (!(strcmp($row_TV['id_empleado'], $row_vale_salida['id_empleado_tv']))) {echo "selected=\"selected\"";} ?>><?php echo $row_TV['lista']?></option>
          <?php
...
mysql_free_result($vale_salida_tipo);
?>
