...
if ((isset($_GET['id_consecutivo'])) && ($_GET['id_consecutivo'] != "")) {
  $deleteSQL = sprintf("DELETE FROM consecutivo WHERE id_consecutivo=%s",
                       GetSQLValueString($_GET['id_consecutivo'], "int"));
