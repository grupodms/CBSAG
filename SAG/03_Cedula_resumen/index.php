...
per_dep_det.id_determinantes
ORDER BY
per_dep_det.clave_determinante ASC ", GetSQLValueString($aDep_per_dep_det, "int"),GetSQLValueString($aPer_A_per_dep_det, "int"),GetSQLValueString($aPer_B_per_dep_det, "int"));
...
<form action="ficheroExcel.php" method="post" target="_blank" id="FormularioExportacion">
 <img src="../../img/descarga_excel.png" width="140" height="59" class="botonExcel" />
...
<td>&nbsp;</td>
 ...
 <br />
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="3">
<?PHP if ($row_dependencia['clave_dependencia'] == "006" ){
?>	   
...
<P style="width: 250px; 
  ...
  font-size:9px">    ----------------------------------------------
    ...
    <td>&nbsp;</td>
    <td colspan="3"><p style="width: 250px; 
  text-align: center;
  font-size:9px">
<?PHP if ($row_dependencia['clave_dependencia'] == "006" ){
?>	   
...
?>	   
   ...
   <?php echo $row_dependencia['cedula_reviso2_nombre']; ?> 
<?PHP } ?>   
   </p></td>
    <td>&nbsp;</td>
    <td colspan="5">
...
?>
  ...
  <?php echo $row_dependencia['cedula_reviso2_puesto']; ?> 
<?PHP } ?>  
