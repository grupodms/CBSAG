...
mysql_select_db($database_SAG, $SAG);
$query_dependencia = sprintf("
SELECT * 
FROM
dependencia
where dependencia.id_dependencia > 0
ORDER BY
dependencia.depen_descripcion ASC
");
...
GetSQLValueString($aDet_cedula_resumen_partidas, "int"));
...
$aDep_per_dep_det = "-1";
if (isset($row_dependencia['id_dependencia'])) {
  $aDep_per_dep_det = $row_dependencia['id_dependencia'];
}
$aPer_A_per_dep_det = "-1";
if (isset($_COOKIE ['id_periodo'])) {
  $aPer_A_per_dep_det = $_COOKIE ['id_periodo'];
...
<P style="width: 100px; 
    ...
    <td style="border: 1px solid black;
               ...
               text-align:center">
    <?php
$aDep =  $row_per_dep_det['id_dependencia'];
$aDet =  $row_per_dep_det['id_determinantes'];	


$query_cedula_resumen_partidas = sprintf($query2_cedula_resumen_partidas, GetSQLValueString($aDep, "int"),
GetSQLValueString($aPer_cedula_resumen_partidas, "int"),
...
GetSQLValueString($aPer_vales_entrada, "int"),
GetSQLValueString($aDet, "int"),
...
GetSQLValueString($aDep, "int"),
GetSQLValueString($aPer_vales_salida, "int"),
GetSQLValueString($aDet, "int"),
GetSQLValueString(1, "int"));
$vales_salida = mysql_query($query_vales_salida, $SAG) or die(mysql_error());
$row_vales_salida = mysql_fetch_assoc($vales_salida);
...
<?PHP    
fputcsv($fp, array(
        $row_dependencia['depen_descripcion'],
        $row_per_dep_det['id_dependencia'],
		$row_per_dep_det['id_determinantes'],
		$row_per_dep_det['clave_determinante'],
		$row_per_dep_det['descripcion'],
		$nCedulaResumen,
		$nValeEnt1 + $nValeEnt2 + $nValeEnt3,
		$nValeSal1 + $nValeSal2 + $nValeSal3,
		$nContable,
		$nInvFisico,
		$nDifMas,
		$nDifMenos
...
<?PHP $nPag +=1; ?>  
  ...
  $nGTot += $nTot; 
  $nGTotContable += $nTotContable;
  $nGTotInvFisico += $nTotInvFisico;
  $nGTotDifMas += $nTotDifMas;
  $nGTotDifMenos += $nTotDifMenos;
  ...
  $nGPTot += $nPTot; 
  $nGPTotContable += $nPTotContable;
  $nGPTotInvFisico += $nPTotInvFisico;
  $nGPTotDifMas += $nPTotDifMas;
  $nGPTotDifMenos += $nPTotDifMenos;
...
<?php } while ($row_dependencia = mysql_fetch_assoc($dependencia)); ?>
  ...
  <tr>
    ...
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGTot; ?></strong> </td>
    
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGE1Tot; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGE2Tot; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGE3Tot; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGS1Tot; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGS2Tot; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGS3Tot; ?></strong> </td>
<td>&nbsp;</td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGPE1Tot; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGPE2Tot; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGPE3Tot; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGPS1Tot; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGPS2Tot; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGPS3Tot; ?></strong> </td>
    
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php echo $nGTotContable; ?></strong> </td>
    <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center"><strong><?php echo $nGTotInvFisico; ?></strong>
    </td>
        <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center"><strong><?php echo $nGTotDifMas; ?></strong>
    </td>
        <td style="border: 1px solid black;
    border-collapse: collapse; text-align:center"><strong><?php echo $nGTotDifMenos; ?></strong>
    </td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    border-collapse: collapse; text-align:center">
	<strong><?php 
	echo $nGTotContable." - ".$nGTotInvFisico." = ".$nGTotContable-$nGTotInvFisico ; ?></strong> 
    
    </td>
        <td colspan="2" style="border: 1px solid black;
    border-collapse: collapse; text-align:center">
	<strong><?php 
	echo $nGTotDifMas." ".$nGTotDifMenos." = ".$nGTotDifMas+$nGTotDifMenos ; ?></strong> 
