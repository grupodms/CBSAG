...
if ((isset($_GET['id_empleado'])) && ($_GET['id_empleado'] != "")) {
  $deleteSQL = sprintf("DELETE FROM empleado WHERE id_empleado=%s",
                       GetSQLValueString($_GET['id_empleado'], "int"));
...
if (isset($_GET['id_empleado'])) {
  $colname_Determinante = $_GET['id_empleado'];
}
mysql_select_db($database_SAG, $SAG);
$query_Determinante = sprintf("SELECT * FROM empleado WHERE id_empleado = %s", GetSQLValueString($colname_Determinante, "int"));
