...
<title>Pagos de Socios ASEM</title>
...
<blockquote>
  <p>
  <h1>Pagos de Socios de ASEM.</h1></p>
</blockquote>

<p><div class="pull-left">
   <a href="../ASEM/nuevo_pagos.php?idasem=<?PHP echo $colname_Pagos ;?>  ">
...
<table width="100%" border="0" align="center" class="table table-hover">
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_Pagos['idasem_pagos']; ?></td>
      
      <td><?php echo $row_Pagos['fecha_pago']; ?></td>
      <td><?php echo $row_Pagos['Referencia']; ?></td>
      <td><?php echo $row_Pagos['importe']; ?></td>
      <td><?php echo $row_Pagos['Fecha_inicio']; ?></td>
      <td><?php echo $row_Pagos['Fecha_fin']; ?></td>
    </tr>
