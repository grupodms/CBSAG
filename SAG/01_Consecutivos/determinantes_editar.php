...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE resguardo_partidas SET id_resguardo=%s, id_estado_fisico=%s, num_serie=%s, entrada_vale=%s, numero_inventario=%s, observaciones=%s, num_seriea=%s, num_serieb=%s, alta=%s, baja=%s , id_determinantes =%s, unidades =%s WHERE id_resguardo_partidas =%s",
...
<blockquote>
  <p>
  <h1>Editar Determinantes  Consecutivos.</h1>
  </p>
</blockquote>
<?php
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td colspan="3"><input type="text" name="id_resguardo" value="<?php echo $row_Resguardo['id_resguardo']; ?>" size="32" 
                 readonly="readonly" 
                 id = "date1picker"
                 class="alert-success"  
           />
      <input type="text" name="id_resguardo_partidas" value="<?php echo $row_Resguardo_detalle['id_resguardo_partidas']; ?>" size="32" 
                 readonly="readonly" 
                 id = "date1picker2"
                 class="alert-success"  
           /></td>
    ...
    <tr valign="baseline">
      ...
      <input name="id_determinantes" type="text" class="alert-success" id="id_determinantes" value="<?php echo $row_Resguardo_detalle['id_determinantes']; ?>" size="5" readonly="readonly" /></td>
      <td width="48"><label for="clave_determinante"></label>
      <input name="clave_determinante" type="text" class="alert-success" id="clave_determinante" value="<?php echo $row_Resguardo_detalle['clave_determinante']; ?>" size="10" readonly="readonly" /></td>
...
do {  
?>
          <option value="<?php echo $row_determinante_2['id_determinantes']?>"<?php if (!(strcmp($row_determinante_2['id_determinantes'], $row_Resguardo_detalle['id_determinantes']))) {echo "selected=\"selected\"";} ?>><?php echo $row_determinante_2['clave_determinante']?></option>
          <?php
...
?>
    ...
    <tr valign="baseline">
      ...
      <td colspan="3"><textarea name="descripcion" cols="45" rows="5" readonly="readonly" class="alert-success" id="descripcion"><?php echo $row_Resguardo_detalle['descripcion']; ?></textarea></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Unidades:</td>
      <td colspan="3"><input name="unidades" type="text" value="<?php echo $row_Resguardo_detalle['unidades']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
...
?>
    ...
    <tr valign="baseline">
      ...
      <td colspan="3"><input name="num_serie" type="text" id="num_serie" value="<?php echo $row_Resguardo_detalle['num_serie']; ?>" size="32" /></td>
    </tr>

    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Numero de vale salida:</td>
      <td colspan="3"><input name="entrada_vale" type="text" class="alert-success" id="entrada_vale" value="<?php echo $row_Resguardo_detalle['entrada_vale']; ?>" size="32" readonly="readonly" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Numero inventario:</td>
      <td colspan="3"><input name="numero_inventario" type="text" id="numero_inventario" value="<?php echo $row_Resguardo_detalle['numero_inventario']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="top" nowrap="nowrap">observaciones:</td>
      <td colspan="3"><label for="observaciones"></label>
      <textarea name="observaciones" id="observaciones" cols="45" rows="5"><?php echo $row_Resguardo_detalle['observaciones']; ?></textarea></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Num. serie 2:</td>
      <td colspan="3"><input name="num_seriea" type="text" id="num_seriea" value="<?php echo $row_Resguardo_detalle['num_seriea']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Num. serie 3:</td>
      <td colspan="3"><input name="num_serieb" type="text" id="num_seriea2" value="<?php echo $row_Resguardo_detalle['num_serieb']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">alta:</td>
      <td colspan="3"><input <?php if (!(strcmp($row_Resguardo_detalle['alta'],1))) {echo "checked=\"checked\"";} ?> type="checkbox" name="alta" id="alta" />
      <label for="alta"></label></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">baja:</td>
      <td colspan="3"><input <?php if (!(strcmp($row_Resguardo_detalle['baja'],1))) {echo "checked=\"checked\"";} ?> type="checkbox" name="baja" id="baja" /></td>
    </tr>                
