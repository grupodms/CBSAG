...
if ((isset($_GET['id_vale_entrada'])) && ($_GET['id_vale_entrada'] != "")) {
  $deleteSQL = sprintf("DELETE FROM vale_entrada WHERE id_vale_entrada=%s",
                       GetSQLValueString($_GET['id_vale_entrada'], "int"));
