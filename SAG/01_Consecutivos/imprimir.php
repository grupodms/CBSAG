...
$maxRows_Resguardo22 = 13;
if (isset($_POST['num_deter'])) {
  $maxRows_Resguardo22 = $_POST['num_deter'];
}

$pageNum_Resguardo22 = 0;
if (isset($_GET['pageNum_Resguardo22'])) {
  $pageNum_Resguardo22 = $_GET['pageNum_Resguardo22'];
}
$startRow_Resguardo22 = $pageNum_Resguardo22 * $maxRows_Resguardo22;

$colname_Resguardo22 = "-1";
if (isset($_GET['id_resguardo'])) {
  $colname_Resguardo22 = $_GET['id_resguardo'];
}
mysql_select_db($database_SAG, $SAG);
$query_Resguardo22 = sprintf("SELECT resguardo_partidas.id_resguardo_partidas, resguardo_partidas.id_resguardo, resguardo_partidas.id_determinantes, resguardo_partidas.clave_determinante, resguardo_partidas.descripcion, resguardo_partidas.cambs, resguardo_partidas.unidades, resguardo_partidas.id_estado_fisico, resguardo_partidas.num_serie, resguardo_partidas.entrada_vale, resguardo_partidas.numero_inventario, resguardo_partidas.observaciones, resguardo_partidas.num_seriea, resguardo_partidas.alta, resguardo_partidas.baja, estado_fisico.clave_estado_fisico FROM resguardo_partidas INNER JOIN estado_fisico ON resguardo_partidas.id_estado_fisico = estado_fisico.id_estado_fisico WHERE id_resguardo = %s ORDER BY
resguardo_partidas.clave_determinante ASC ", GetSQLValueString($colname_Resguardo22, "int"));
$query_limit_Resguardo22 = sprintf("%s LIMIT %d, %d", $query_Resguardo22, $startRow_Resguardo22, $maxRows_Resguardo22);
$Resguardo22 = mysql_query($query_limit_Resguardo22, $SAG) or die(mysql_error());
$row_Resguardo22 = mysql_fetch_assoc($Resguardo22);

if (isset($_GET['totalRows_Resguardo22'])) {
  $totalRows_Resguardo22 = $_GET['totalRows_Resguardo22'];
} else {
  $all_Resguardo22 = mysql_query($query_Resguardo22);
  $totalRows_Resguardo22 = mysql_num_rows($all_Resguardo22);
}
$totalPages_Resguardo22 = ceil($totalRows_Resguardo22/$maxRows_Resguardo22)-1;

$queryString_Resguardo22 = "";
if (!empty($_SERVER['QUERY_STRING'])) {
  $params = explode("&", $_SERVER['QUERY_STRING']);
  $newParams = array();
  foreach ($params as $param) {
    if (stristr($param, "pageNum_Resguardo22") == false && 
        stristr($param, "totalRows_Resguardo22") == false) {
      array_push($newParams, $param);
    }
  }
  if (count($newParams) != 0) {
    $queryString_Resguardo22 = "&" . htmlentities(implode("&", $newParams));
  }
}
$queryString_Resguardo22 = sprintf("&totalRows_Resguardo22=%d%s", $totalRows_Resguardo22, $queryString_Resguardo22);
...
mysql_select_db($database_SAG, $SAG);
$query_Resguardo = sprintf("SELECT resguardo.id_resguardo, resguardo.fecha, resguardo.id_periodo, periodo.semestre,
periodo.periodo_fecha, resguardo.id_dependencia, dependencia.clave_dependencia, dependencia.depen_descripcion, resguardo.id_area, area.clave_area, area.des_area, resguardo.id_consecutivo, consecutivo.clave_conse, consecutivo.descripcion_consecutivo, resguardo.id_empleado_tm, empleado_tm.matricula as tm_matricula, empleado_tm.rfc as tm_rfc, empleado_tm.curp as tm_curp, empleado_tm.nombre as tm_nombre, empleado_tm.puesto as tm_puesto, empleado_tm.adcripcion as tm_adcripcion,  resguardo.id_empleado_tv, empleado_tv.matricula as tv_matricula, empleado_tv.rfc as tv_rfc, empleado_tv.curp as tv_curp, empleado_tv.nombre as tv_nombre, empleado_tv.puesto as tv_puesto, empleado_tv.adcripcion as tv_adcripcion
 FROM resguardo INNER JOIN area ON resguardo.id_area = area.id_area INNER JOIN dependencia ON resguardo.id_dependencia = dependencia.id_dependencia INNER JOIN periodo ON resguardo.id_periodo = periodo.id_periodo INNER JOIN consecutivo ON resguardo.id_consecutivo = consecutivo.id_consecutivo INNER JOIN empleado AS empleado_tm ON resguardo.id_empleado_tm = empleado_tm.id_empleado INNER JOIN empleado AS empleado_tv ON resguardo.id_empleado_tv = empleado_tv.id_empleado WHERE resguardo.id_resguardo = %s", GetSQLValueString($colname_Resguardo, "int"));
...
<?PHP
#########################
$colname_Resguardo2 = "-1";
if (isset($_GET['id_resguardo'])) {
  $colname_Resguardo2 = $_GET['id_resguardo'];
}
mysql_select_db($database_SAG, $SAG);
$query_Resguardo2 = sprintf("
SELECT sum(unidades) AS tot_uni FROM resguardo_partidas
WHERE resguardo_partidas.id_resguardo = %s", GetSQLValueString($colname_Resguardo2, "int"));
$Resguardo2 = mysql_query($query_Resguardo2, $SAG) or die(mysql_error());
$row_Resguardo2 = mysql_fetch_assoc($Resguardo2);
$totalRows_Resguardo2 = mysql_num_rows($Resguardo2);
...
if (isset($_GET['totalRows_Resguardo2'])) {
  ...
  $totalRows_Resguardo2 = mysql_num_rows($all_Rresguardo2);
}
...
?>
  ...
  <tr>
    <form action="imprimir.php?id_resguardo=<?PHP echo $colname_Resguardo22 ?>" method="post" name="imp">
    <td colspan="2">Número Determinantes por Hoja</td>
    <td><input name="num_deter" 
             type="text" 
             id="num_deter" 
             value="<?PHP echo $maxRows_Resguardo22; ?>" size="5" /></td>
    <td><input type="submit" 
         class="bg bg-success" u
         value="Actualizar" /></td>
    <td rowspan="2">
    </form>
      <a href="javascript:imprSelec('muestra')"><img src="../img/impresora.png" width="50" height="50" /></a>
    </td>
    <td rowspan="2"><img src="../img/excel.gif" width="50" height="50" /></td>
    <td rowspan="2"><img src="../img/pdf.gif" width="50" height="50" /></td>
    <td rowspan="2"><img src="../img/correo.png" width="50" height="50" /></td>
  </tr>
  <tr>
    <td width="8%">
<a href="<?php printf("%s?pageNum_Resguardo22=%d%s", $currentPage, 0, $queryString_Resguardo22); ?>">
    ...
    <td width="7%">
    <a href="<?php printf("%s?pageNum_Resguardo22=%d%s", $currentPage, max(0, $pageNum_Resguardo22 - 1), $queryString_Resguardo22); ?>">
    <button type="button" class="btn btn-success"> 
    <span class="glyphicon glyphicon-backward"></span>    
    Anterior
    </button>  
    </a></td>
    <td width="15%"><a href="<?php printf("%s?pageNum_Resguardo22=%d%s", $currentPage, min($totalPages_Resguardo22, $pageNum_Resguardo22 + 1), $queryString_Resguardo22); ?>">
    <button type="button" class="btn btn-success"> 
    ...
    <td>
    <a href="<?php printf("%s?pageNum_Resguardo22=%d%s", $currentPage, $totalPages_Resguardo22, $queryString_Resguardo22); ?>">
    <button type="button" class="btn btn-success"> 
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:12.9pt'>
  ...
  style='font-size:12.0pt;mso-bidi-font-size:11.0pt'>Sistema Integral de
    ...
    <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><b style='mso-bidi-font-weight:normal'><span
  style='font-size:12.0pt;mso-bidi-font-size:11.0pt'>RESGUARDO DE ACTIVO FIJO  &nbsp; <?php echo $row_Periodo['semestre']; ?> </span></b></p>  </td>
...
<span style="font-size: 6.0pt; 
 ...
 <?php 
 $sub_hoja = 0;
 $num_part = 0+(($pageNum_Resguardo22)*$maxRows_Resguardo22);
 ?>
 <?php do { ?>
 <?PHP  
 $sub_hoja = $sub_hoja + $row_Resguardo22['unidades'];
 $num_part += 1 ;
 ?>
  ...
  normal'><span style='font-size:7.0pt;font-family:"Arial","sans-serif"'>
         <span class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  ...
  normal"><span style="font-size:7.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;">
       <o:p><?php echo $row_Resguardo22['clave_determinante']; ?> &nbsp;<br/>
         <?php echo $row_Resguardo22['cambs']; ?></o:p>
     </span></span></td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
       ...
       <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:7.0pt;font-family:"Arial","sans-serif"'><o:p><?php echo $row_Resguardo22['descripcion']; ?></o:p></span></p></td>
     <td width=20 valign=top style='width:20.65pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
       <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:right;line-height:normal'><span style="font-size:7.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;"><?php echo $row_Resguardo22['clave_estado_fisico']; ?></span></p>  </td>
  ...
  text-align:center;line-height:normal'>
         ...
         <span style='font-size:7.0pt;font-family:"Arial","sans-serif"'>
           <?php echo $row_Resguardo22['unidades']; ?>&nbsp;
         </span></p>  
     </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
       <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:6.0pt;font-family:"Arial","sans-serif"'><o:p><?php echo $row_Resguardo22['num_serie']; ?><br /><?php echo $row_Resguardo22['num_seriea']; ?><br /><?php echo $row_Resguardo22['num_serieb']; ?>&nbsp;</o:p></span></p>  </td>
     <td colspan=5 valign=top style='width:254.05pt;border-top:none;
  border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
       <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:7.0pt;font-family:"Arial","sans-serif"'><o:p><?php echo $row_Resguardo22['observaciones']; ?>&nbsp;</o:p></span></p>  </td>
     <![if !supportMisalignedRows]>
     <td style='border:none' width=1><p class='MsoNormal'></td>
     <![endif]>
   </tr>
   <?php } while ($row_Resguardo22 = mysql_fetch_assoc($Resguardo22)); ?>
...
<?PHP 
$Pag  = $pageNum_Resguardo22+1;
$TPag = $totalPages_Resguardo22+1; 
?>  
<?PHP echo $Pag; ?>/<?PHP echo $TPag; ?><o:p></o:p></span></p>  </td>
 ...
 <tr style='mso-yfti-irow:10;mso-yfti-lastrow:yes;height:6.35pt'>
  ...
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:right;line-height:normal'><span style='font-size:6.0pt;font-family:
  "Arial","sans-serif"'><?php echo $row_Resguardo2['tot_uni']; ?><o:p></o:p></span></p>  </td>
  <![if !supportMisalignedRows]>
