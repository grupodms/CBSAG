...
mysql_select_db($database_SAG, $SAG);
$query_resguardo_partidas = sprintf("SELECT * FROM resguardo_partidas WHERE id_resguardo = %s ORDER BY
resguardo_partidas.clave_determinante ASC
" , GetSQLValueString($colname_resguardo_partidas, "int"));
...
<blockquote>
  ...
  <tr>
    <td ><h1>Consecutivo Resguardo <?php if( $row_Periodo['resguardo']==0) {echo 'Lectura'; }?></h1> </td>
  </tr>
</table> 
  ...
  <form action="index2.php" method="post">  <table width="863" border="0">
    <tr valign="middle">
      ...
      <td>Periodo :</td>
      <td><?php echo $row_Periodo['semestre']; ?></td>
      <td><a href="imprimir_todo.php?id_resguardo=<?PHP echo $row_resguardo['id_resguardo'];?>  ">
        <button type="button" class="btn btn-success"> <span class="glyphicon glyphicon-print"></span>&nbsp;Resguardo Completo </button>
      </a></td>
      <td>&nbsp;</td>
    </tr>
    <tr valign="middle">
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><?php echo $row_Periodo['id_periodo']; ?></td>
      <td><a href="imprimir.php?id_resguardo=<?PHP echo $row_resguardo['id_resguardo'];?>  ">
        <button type="button" class="btn btn-success"> <span class="glyphicon glyphicon-print"></span>&nbsp;Resguardo por Hoja </button>
      </a>&nbsp;</td>
      <td>
<?php if ($row_Periodo['resguardo']==1) { ?>      
      <a href="editar.php?id_resguardo=<?PHP echo $row_resguardo['id_resguardo'];?>  ">
...
<?php if ($row_Periodo['resguardo']==1) { ?>      
      ...
      <a href="determinantes_editar.php?id_resguardo=<?PHP echo $row_resguardo_partidas['id_resguardo'];?>&id_resguardo_partidas=<?php echo  $row_resguardo_partidas['id_resguardo_partidas']; ?>
&id_area=<?PHP echo $id_area; ?>
&id_consecutivo=<?PHP echo $id_consecutivo; ?>">
...
<?PHP } ?>      
      ...
      <td width="100">
<?php if ($row_Periodo['resguardo']==1) { ?>      
      <a href="determinantes_traspaso.php?id_resguardo=<?PHP echo $row_resguardo_partidas['id_resguardo'];?>&id_resguardo_partidas= <?php echo $row_resguardo_partidas['id_resguardo_partidas']; ?>   ">
...
<?PHP } ?>      
      ...
      <td width="42"><?PHP if ($row_resguardo_partidas['unidades'] > 1) { ?>
        <a href="index2.php?id_resguardo=<?PHP //echo $row_resguardo_partidas['id_resguardo'];?>&id_resguardo_partidas= <?php //echo $row_resguardo_partidas['id_resguardo_partidas']; ?>   "> </a>
        <?PHP } ?>

<?php if ($row_Periodo['resguardo']==1) { ?>        
<a href="determinantes_eliminar.php?
id_resguardo=<?PHP echo $row_Resguardo['id_resguardo'];?>&id_resguardo_partidas= <?php echo $row_resguardo_partidas['id_resguardo_partidas'];?> 
&id_area=<?PHP echo $id_area; ?>
&id_consecutivo=<?PHP echo $id_consecutivo; ?>"
