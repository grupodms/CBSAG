...
$Resguardo22 = mysql_query($query_Resguardo22, $SAG) or die(mysql_error());
...
?>
  ...
  <tr>
    ...
    <td width="56%">Número Determinantes por Hoja</td>
    <td width="9%"><input name="num_deter" 
             type="text" 
             id="num_deter" 
...
<span style="font-size: 6.0pt; 
 ...
 <?php 
 $sub_hoja = 0;
$pageNum_Resguardo22 +=  1;
 //+(($pageNum_Resguardo22)*$maxRows_Resguardo22);
 ?>
...
<?PHP $num_part += 1; ?>
 ...
 <?PHP $row_Resguardo22 = mysql_fetch_assoc($Resguardo22); ?>   
<?PHP }?>   
   

   
<?PHP if (fmod($num_part,13) == 0) 
{ 
//$enca = true;
}
?>
