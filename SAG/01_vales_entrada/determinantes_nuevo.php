...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO vale_entrada_partidas (id_vale_entrada_partidas, id_vale_entrada, id_determinantes, unidades, id_estado_fisico, num_serie, entrada_vale, numero_inventario, observaciones, num_seriea, num_serieb, alta, baja, clave_determinante, descripcion, cambs) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )",
                       ...
                       GetSQLValueString($_POST['entrada_vale'], "text"),
...
//echo $insertSQL;
  ...
  $insertGoTo = "determinantes_index.php?". $row_vale_entrada['id_vale_entrada'] . "=";
...
if (isset($_GET['id_vale_entrada_partidas'])) {
  $colname_vale_entrada_partidas = $_GET['id_vale_entrada_partidas'];
}
mysql_select_db($database_SAG, $SAG);
$query_vale_entrada_partidas = sprintf("SELECT * FROM vale_entrada_partidas WHERE id_vale_entrada_partidas = %s", GetSQLValueString($colname_vale_entrada_partidas, "int"));
...
<blockquote>
  <p>
  <h1>Nuevo Articulo de Vales de Entrada</h1>
  </p>
</blockquote>
...
<input type="hidden" name="id_vale_entrada_partidas" value="" />
  <table align="center">

    <tr valign="baseline">
      <td nowrap="nowrap" align="right">id:</td>
      <td><input type="text" name="id_vale_entrada" value="<?php echo $row_vale_entrada['id_vale_entrada']; ?>" size="32" 
                 readonly="readonly" 
                 id = "date1picker"
                 class="alert-success"  
           /></td>
...
<a href="index.php?id_vale_entrada=<?php echo $row_vale_entrada['id_vale_entrada']; ?>">
