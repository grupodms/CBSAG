...
if (isset($_GET['id_vale_entrada'])) {
  $colname_vales_partidas = $_GET['id_vale_entrada'];
}
mysql_select_db($database_SAG, $SAG);
$query_vales_partidas = sprintf("SELECT * FROM vale_entrada_partidas WHERE id_vale_entrada = %s ORDER BY clave_determinante ASC", GetSQLValueString($colname_vales_partidas, "int"));
...
<table width="80%" 
  ...
  <tr>
    ...
    <td width="158">&nbsp;</td>
    <td width="158">Num:</td>
    <td width="158"><?php echo $row_vale_entrada['id_vale_entrada']; ?></td>
  </tr>
  <tr>
    ...
    <td>Fecha: </td>
    <td>
    <?php echo $row_vale_entrada['fecha']; ?>
    <td>
    
      </td>
  </tr>
  <tr>
    <td colspan="7">Vale de Entrada de <?php echo $row_vale_entrada['clave_vale_entrada_tipo']; ?> <?php echo $row_vale_entrada['semestre']; ?></td>
  </tr>
    <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>Observaciones: </td>
    <td colspan="2" rowspan="3"><?php echo $row_vales_partidas['observaciones']; ?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
