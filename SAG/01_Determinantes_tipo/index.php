...
$query_Reg_Deter_tipo = "SELECT * FROM determinante_tipo ORDER BY deter_descripcion ASC";
$Reg_Deter_tipo = mysql_query($query_Reg_Deter_tipo, $SAG) or die(mysql_error());
$row_Reg_Deter_tipo = mysql_fetch_assoc($Reg_Deter_tipo);
$totalRows_Reg_Deter_tipo = mysql_num_rows($Reg_Deter_tipo);
...
<table width="100%" border="0" align="center" class="table table-hover">
  ...
  <?php do { ?>
  <tr>
   <td><?php echo $row_Reg_Deter_tipo['id_determinante_tipo']; ?></td>
   <td><?php echo $row_Reg_Deter_tipo['deter_descripcion']; ?></td>
   <td><a href="editar.php?id_determinante_tipo=<?PHP echo $row_Reg_Deter_tipo['id_determinante_tipo'];?>  ">
  <button type="button" class="btn btn-success">
    <span class="glyphicon glyphicon-pencil"></span>Editar      </button>
</a></td>
      <td><a href="eliminar.php?id_determinante_tipo=<?PHP echo $row_Reg_Deter_tipo['id_determinante_tipo'];?>"
      onclick="return confirmar()">
      <button type="button" class="btn btn-danger">
      <span class="glyphicon glyphicon-trash"></span>
      Eliminar      </button></a></td>
    </tr>
    <?php } while ($row_Reg_Deter_tipo = mysql_fetch_assoc($Reg_Deter_tipo)); ?>
</table>
...
<?php
mysql_free_result($Reg_Deter_tipo);
